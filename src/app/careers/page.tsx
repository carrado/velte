    ...
    <>
      ...
      <main className="bg-[#F1F5F9] min-h-screen pt-24 pb-20">
        ...
        <section className="relative overflow-hidden">
          ...
          />
          <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-orange-500/[0.07] rounded-full blur-[120px] pointer-events-none" />
        ...
        <section className="max-w-7xl mx-auto px-5 sm:px-8 pb-24">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="bg-white border border-gray-200 shadow-sm rounded-3xl p-12 text-center"
          >
            <div className="w-16 h-16 rounded-full bg-orange-500/10 flex items-center justify-center mx-auto mb-4">
              <Briefcase className="w-8 h-8 text-orange-500" />
            </div>
            <h3 className="text-3xl font-bold text-[#023337] mb-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-6 py-3 rounded-lg shadow-lg shadow-orange-500/25 transition-colors"
            >
