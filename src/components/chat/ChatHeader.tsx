      ...
      <div className="flex items-center gap-1 sm:gap-2 shrink-0">
        {userDetails ? (
          ...
          <div className="flex items-center gap-1 min-w-0">
            <UpgradeCta className="hidden sm:inline-flex items-center gap-1.5 rounded-full border border-orange-200 bg-orange-50 px-3 py-1.5 text-xs font-semibold text-orange-600 transition-colors hover:bg-orange-100" />
            <Link
              href="/chat/watches"
          ...
          <div className="flex items-center gap-1.5 sm:gap-4 text-sm font-medium shrink-0">
            ...
            <UpgradeCta
              label="Plans"
              className="hidden sm:inline-flex items-center gap-1.5 rounded-full border border-orange-200 bg-orange-50 px-3 py-1.5 text-xs font-semibold text-orange-600 transition-colors hover:bg-orange-100"
            />
            <Link
              href="/auth/login"
