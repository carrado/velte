  ...
  return (
    <div className="relative w-full max-w-[340px] mx-auto lg:mx-0">
      ...
      <div className="relative bg-[#0d1b12] border border-white/10 rounded-3xl overflow-hidden shadow-2xl shadow-black/50">
        ...
        >
          ...
          <div className="min-w-0">
            <p className="text-white font-semibold text-sm leading-none">Velte Sales Agent</p>
      ...
      <motion.div
        ...
        className="absolute -left-4 top-[28%] hidden sm:flex items-center gap-2 bg-[#0d2018] border border-emerald-500/25 rounded-xl px-3 py-2 shadow-xl"
      >
      ...
      <motion.div
        ...
        className="absolute -right-4 bottom-[22%] hidden sm:flex items-center gap-2 bg-[#0d2018] border border-emerald-500/25 rounded-xl px-3 py-2 shadow-xl"
      >
...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#050d08]">
      ...
      {/* Gradient glows */}
      <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-emerald-500/[0.12] rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/3 w-[320px] h-[320px] bg-teal-400/[0.08] rounded-full blur-[80px] pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <motion.div variants={stagger} initial="hidden" animate="show">
            <motion.div variants={fadeUp}>
              <span className="inline-flex items-center gap-2 bg-emerald-500/[0.1] border border-emerald-500/[0.2] text-emerald-400 text-xs font-semibold px-3.5 py-1.5 rounded-full mb-7 tracking-wide">
            ...
            >
              Deploy an intelligent AI agent on your WhatsApp Business number that answers
              product questions, negotiates prices, checks inventory, and closes sales — 24 hours
              a day, 7 days a week.
            </motion.p>
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-3 mb-10">
              <Link href="/sign-in">
                <Button
                  size="lg"
                  className="bg-emerald-500 hover:bg-emerald-400 text-white shadow-xl shadow-emerald-500/25 text-[15px] px-8 gap-2 h-12 w-full sm:w-auto"
                >
                  Start Free Trial
              ...
              <Button
                size="lg"
                variant="ghost"
                className="text-white/70 hover:text-white hover:bg-white/[0.08] text-[15px] gap-2.5 h-12 border border-white/10"
              >
